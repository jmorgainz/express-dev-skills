...
app.use(logger('dev'));
// Processes data sent in the body of the request (json)
app.use(express.json());
// Processes data sent in 'form' body of the request
// It will create a property on req.body <input>, <select>, and <textarea>
app.use(express.urlencoded({ extended: false }));
// add a cookies property for each cookie sent in the request
app.use(cookieParser());
// If the request is for static assets, returns that file
